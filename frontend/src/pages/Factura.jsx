        ...
        >
          ...
          <div className="grid gap-5 border-b border-[#D8BA98] p-8 sm:grid-cols-2 sm:px-10">
            ...
            <div className="rounded-2xl border border-[#D8BA98]/70 bg-white/60 p-5">
              ...
              {emailCliente && (
                <p className="mt-1 break-all text-sm text-[#765E52]">
                  {emailCliente}
                </p>
              )}
            ...
            <div className="rounded-2xl border border-[#D8BA98]/70 bg-white/60 p-5">
              ...
              <span className="inline-flex rounded-full bg-[#D4AF37]/20 px-3 py-1.5 text-xs font-bold text-[#7F0303]">
                Compra registrada
              </span>

              <p className="mt-2 text-xs text-[#765E52]">
