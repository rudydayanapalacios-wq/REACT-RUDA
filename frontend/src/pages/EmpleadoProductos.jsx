  ...
  useEffect(() => {
    const cargarProductos = async () => {
      try {
        ...
        // Siempre comenzar en la primera página
        setPaginaActual(1);
      } catch (error) {
        console.error(
  ...
  return (
    <section className="h-screen overflow-y-auto bg-[#EFE8DF] px-6 py-12">
      ...
      {productoSeleccionado && (
        ...
        >
          <div
            className="my-auto w-full max-w-lg overflow-hidden rounded-[30px] bg-[#F8F3EA] shadow-2xl"
            onClick={(evento) =>
              evento.stopPropagation()
            }
          >
            <div className="h-2 bg-gradient-to-r from-[#7F0303] via-[#D4AF37] to-[#8B6F47]" />
              ...
              <div className="mt-7 space-y-4">
                ...
                <div className="overflow-hidden rounded-2xl bg-white/60">
                  {obtenerRutaImagen(
                    ...
                    <div className="flex h-40 items-center justify-center bg-[#7F0303]/5 text-sm text-[#765E52]">
                      Imagen no disponible
                    </div>
                  )}
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="rounded-2xl bg-white/60 p-4">
                    ...
                    <p className="mt-2 text-sm font-semibold text-[#7F0303]">
                      #
                ...
                <div className="rounded-2xl bg-white/60 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-[#765E52]">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="rounded-2xl bg-white/60 p-4">
                    ...
                    <p className="mt-2 text-lg font-bold text-[#7F0303]">
                      $
                      {Number(
